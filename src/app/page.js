...
export default function Home() {
  return (
    <main className={styles.testContainer}>
      <h1> My simple Next app test</h1>
      <section>Test for Firebase deploy</section>
      <div>
        <svg
          width="800px"
          height="800px"
        ...
        >
          ...
          />
          <path
            d="M349.5 104m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z"
            fill="#FFEB4D"
          />
          <path
          ...
          <path
            d="M362.9 618.8h-7.5c-4.4 0-8-3.6-8-8s3.6-8 8-8h7.5c4.4 0 8 3.6 8 8s-3.6 8-8 8z"
            fill="#9A2D2F"
          />
          ...
          <path
            d="M417.8 854.8h-9.4c-4.4 0-8-3.6-8-8s3.6-8 8-8h9.4c4.4 0 8 3.6 8 8s-3.6 8-8 8z"
            fill="#9A2D2F"
          />
          <path
